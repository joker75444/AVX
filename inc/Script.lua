...
redis:set(Av.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(Av..'lock:join:'..msg.chat_id_,true)
...
redis:del(Av..'lock:join:'..msg.chat_id_)
return "*★ ** أهلا عزيزي *"..msg.TheRankCmd.."*\n★ ** تم فتح الدخول بالرابط \n*" 
end


local function iAv(msg,MsgText)

Channel = redis:get(Av..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(Av..'joinchnl') then
...
redis:setex(Av..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(Av..'CheckExpire::'..msg.chat_id_) then 
redis:set(Av..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️│في مجموعه  » »  '..redis:get(Av..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if MsgText[2] == '1' then
redis:setex(Av..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(Av..'CheckExpire::'..msg.chat_id_) then 
redis:set(Av..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم تفعيل الاشتراك   👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم تفعيل الاشتراك  👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(Av..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(Av..'CheckExpire::'..msg.chat_id_) then 
redis:set(Av..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(Av..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(Av..'CheckExpire::'..msg.chat_id_) then 
redis:set(Av..'CheckExpire::'..msg.chat_id_,true) end
...
local check_time = redis:ttl(Av..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(Av..'group:name'..msg.chat_id_) or '')
redis:set(Av..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
users = redis:get(Av..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if not msg.Director then return "★ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. Av..'')
...
if not msg.Director and redis:get(Av..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(Av..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Admin then return "★ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not MsgText[2] and msg.reply_id then
if redis:get(Av..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(Av..'lock:kara:'..msg.chat_id_) == 'on' then
...
local Admins = redis:scard(Av..'admins:'..msg.chat_id_)
redis:del(Av..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(Av..'owners:'..msg.chat_id_)
redis:del(Av..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(Av..'whitelist:'..msg.chat_id_)
redis:del(Av..'whitelist:'..msg.chat_id_)
...
if not msg.Director then return "★ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(Av..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(Av..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(Av..'ExCmdLink'..msg.chat_id_,120,true)
...
if not msg.Director then return "★ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(Av..'linkGroup'..msg.sender_user_id_,300,true)
return '★ عزيزي قم برسال الرابط الجديد ...🍂'
end

if MsgText[1] == "الرابط" then
if not redis:get(Av..'linkGroup'..msg.chat_id_) then 
return "★ ** اوه لا يوجد رابط .\n★ **لانشاء رابط ارسل { `انشاء رابط` }\n" 
end
local GroupName = redis:get(Av..'group:name'..msg.chat_id_)
local GroupLink = redis:get(Av..'linkGroup'..msg.chat_id_)
...
local Text = "★ رابـط الـمـجـمـوعه★ \n"..Flter_Markdown(redis:get(Av..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
redis:set(Av..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "★ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Mn3Word = redis:scard(Av..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "★ ** عذراً لا توجد كلمات ممنوعه ليتم حذفها" 
end
redis:del(Av..':Filter_Word:'..msg.chat_id_)
...
redis:del(Av..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "★ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(Av..'welcome:msg'..msg.chat_id_) then 
return "★ ** اوه هنالك خطأ .\n★ عذراً لا يوجد ترحيب ليتم مسحه ." 
end
redis:del(Av..'welcome:msg'..msg.chat_id_)
...
local NumMnsha = redis:scard(Av..':Hussain:'..msg.chat_id_)
if NumMnsha ==0 then 
return "★ عذراً لا يوجد منشى اساسي \n!" 
end
redis:del(Av..':Hussain:'..msg.chat_id_)
...
if not msg.SudoUser then return "★ **هذا الامر يخص {المطور} فقط  \n" end
local NumMnsha = redis:scard(Av..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "★ عذراً لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(Av..':MONSHA_BOT:'..msg.chat_id_)
...
local list = redis:smembers(Av..'banned:'..msg.chat_id_)
if #list == 0 then return "*★ لا يوجد مستخدمين محظورين  *" end
message = '★ ** قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(Av..'banned:'..msg.chat_id_)
return "★ **أهلا عزيزي "..msg.TheRankCmd.."   \n★  تم مسح {* "..#list.." *} من المحظورين  \n"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "★ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MKTOMEN = redis:scard(Av..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "★ ** لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(Av..'is_silent_users:'..msg.chat_id_)
...
redis:del(Av..'linkGroup'..msg.chat_id_)
...
if not msg.Creator then return "★ **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(Av..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(Av..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "★ **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(Av..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(Av..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(Av..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(Av..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(Av..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
if redis:get(Av..'lock_id'..msg.chat_id_) then 
local msgs = redis:get(Av..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then UserNameID = "@"..data.username_.."" else UserNameID = "" end
local points = redis:get(Av..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if points and points ~= "0" then
nko = points
else
nko = '0'
end
local rfih = (redis:get(Av..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(Av..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local Namei = FlterName(data.first_name_..' '..(data.last_name_ or ""),20)
GetPhotoUser(msg.sender_user_id_,function(arg, data)
if redis:get(Av.."getidstatus"..msg.chat_id_) == "Photo" then
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(Av..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(Av..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(Av..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(Av..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(Av..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(Av..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(Av..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(Av..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(Av..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:del(Av..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "★ **تم مسح {* "..msgs.." *} من رسائلك .\n"
end

if MsgText[1]== 'جهاتي' then
return '★ **  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(Av..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(Av..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "★ **عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(Av..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
local points = redis:get(Av..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
if points == 0 then  return "★ **عذرا ليس لديك نقاط لكِ يتم مسحها" end
redis:del(Av..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(Av..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(Av..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(Av..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(Av..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(Av..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(Av..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(Av..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(Av..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(Av..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "★ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:set(Av..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "★ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if redis:get(Av..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(Av..'welcome:msg'..msg.chat_id_))
else 
return "★ **أهلا عزيزي "..msg.TheRankCmd.."  \n★ نورت المجموعه \n" 
end 
end
...
local groups = redis:smembers(Av..'group:ids')
...
local pv = redis:smembers(Av..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(Av..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(Av..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[★ اهلا انا بوت]]..redis:get(Av..':NameBot:')..[[ .
...
if not msg.SudoUser then return "★ **هذا الامر يخص {المطور} فقط  \n" end
if redis:sismember(Av..'group:ids',MsgText[2]) then
local name_gp = redis:get(Av..'group:name'..MsgText[2])
...
return redis:get(Av..":TEXT_SUDO") or '★ لا توجد كليشه المطور .\n★ يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end

if MsgText[1] == "اذاعه بالتثبيت"  or MsgText[1] =="ااذاعه بالتثبيت ♥" then
if not msg.SudoUser then return"★ **هذا الامر يخص {المطور} فقط  \n🚶" end
if not msg.SudoBase and not redis:get(Av..'lock_brod') then return "★ ** الاذاعه مقفوله من قبل المطور الاساسي ." end
redis:setex(Av..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,300, true) 
return "★ حسننا الان ارسل الكليشه للاذاعه بالتثبيت  \n ♥" 
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه 📣" then
if not msg.SudoUser then return"★ **هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(Av..'lock_brod') then 
return "★ ** الاذاعه مقفوله من قبل المطور الاساسي  ." 
end
redis:setex(Av..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(Av..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(Av..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(Av..'fwd:groups'..msg.sender_user_id_,300, true) 
...
if not msg.Admin then return "★ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:del(Av..'welcom:witting'..msg.sender_user_id_,
Av..'rulse:witting'..msg.sender_user_id_,
Av..'rulse:witting'..msg.sender_user_id_,
Av..'name:witting'..msg.sender_user_id_,
Av..'about:witting'..msg.sender_user_id_,
Av..'fwd:all'..msg.sender_user_id_,
Av..'fwd:pv'..msg.sender_user_id_,
Av..'fwd:groups'..msg.sender_user_id_,
Av..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,
Av..'namebot:witting'..msg.sender_user_id_,
Av..'addrd_all:'..msg.sender_user_id_,
Av..'delrd:'..msg.sender_user_id_,
Av..'addrd:'..msg.sender_user_id_,
Av..'delrdall:'..msg.sender_user_id_,
Av..'text_sudo:witting'..msg.sender_user_id_,
Av..'addrd:'..msg.chat_id_..msg.sender_user_id_,
Av..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
redis:set(Av..":VERSION",GetVerison)
return false
else
...
return '★ اصدار سورس Av : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'★ ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس Av يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/Av_bot1"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : Av](https://t.me/Av_bot1)' ,nil,inline,msg.id_)
return false
end
...
if MsgText[1]== "المبرمج الجوكر" and msg.type == "pv" then
local inline = {{{text="-مبرمج السورس اضـغـط هـنـآ ",url="https://t.me/A_j_o_k_e_r"}}}
send_key(msg.sender_user_id_,'   [مبرمج السورس](https://t.me/A_j_o_k_e_r)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "محمد المالك" and msg.type == "pv" then
local inline = {{{text="-مطور السورس اضـغـط هـنـآ ",url="https://t.me/mo_7_med"}}}
send_key(msg.sender_user_id_,'   [مطور السورس](https://t.me/mo_7_med)' ,nil,inline,msg.id_)
return false
end
...
if not msg.SudoBase then return"★ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '★ الاحصائيات . \n\n★ **عدد المجموعات المفعله : '..redis:scard(Av..'group:ids')..'\n★ **عدد المشتركين في البوت : '..redis:scard(Av..'users')..'\n'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"★ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(Av..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(Av..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.Director then return "★ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names 	= redis:exists(Av..'replay:'..msg.chat_id_)
local photo 	= redis:exists(Av..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(Av..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(Av..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(Av..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(Av..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(Av..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(Av..'replay:'..msg.chat_id_,Av..'replay_photo:group:'..msg.chat_id_,Av..'replay_voice:group:'..msg.chat_id_,
Av..'replay_animation:group:'..msg.chat_id_,Av..'replay_audio:group:'..msg.chat_id_,Av..'replay_sticker:group:'..msg.chat_id_,Av..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(Av..'replay:all')
local photo 	= redis:exists(Av..'replay_photo:group:')
local voice 	= redis:exists(Av..'replay_voice:group:')
local imation 	= redis:exists(Av..'replay_animation:group:')
local audio 	= redis:exists(Av..'replay_audio:group:')
local sticker 	= redis:exists(Av..'replay_sticker:group:')
local video 	= redis:exists(Av..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(Av..'replay:all',Av..'replay_photo:group:',Av..'replay_voice:group:',Av..'replay_animation:group:',Av..'replay_audio:group:',Av..'replay_sticker:group:',Av..'replay_video:group:')
...
if not msg.SudoBase then return"★ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:set(Av..'delrdall:'..msg.sender_user_id_,true) 
return "★ حسننا عزيزي  .\n★ الان ارسل الرد لمسحها من  المجموعات ."
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "★ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:set(Av..'delrd:'..msg.sender_user_id_,true)
return "★ حسننا عزيزي  .\n★ الان ارسل الرد لمسحها من  للمجموعه ."
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "★ *│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names  	= redis:hkeys(Av..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(Av..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(Av..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(Av..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(Av..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(Av..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(Av..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(Av..'replay:all')
local photo 	= redis:hkeys(Av..'replay_photo:group:')
local voice 	= redis:hkeys(Av..'replay_voice:group:')
local imation 	= redis:hkeys(Av..'replay_animation:group:')
local audio 	= redis:hkeys(Av..'replay_audio:group:')
local sticker 	= redis:hkeys(Av..'replay_sticker:group:')
local video 	= redis:hkeys(Av..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '★ **لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
...
if not msg.Director then return "★ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(Av..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(Av..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "★ حسننا , الان ارسل كلمه الرد \n"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"★ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(Av..'namebot:witting'..msg.sender_user_id_,300,true)
...
★روايات ➫يقوم البوت بعرض لك بعض الروايات . 
...
if not msg.Admin then return "★ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n★ " end
if not redis:get(Av..'lave_me'..msg.chat_id_) then 
return "★ **أهلا عزيزي "..msg.TheRankCmd.."\n★ ** المغادره بالتاكيد تم تفعيلها\n★" 
else 
redis:del(Av..'lave_me'..msg.chat_id_) 
return "★ **أهلا عزيزي "..msg.TheRankCmd.."\n★ ** تم تفعيل المغادره \n★" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "★ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n★ " end
if redis:get(Av..'lave_me'..msg.chat_id_) then 
return "★ **أهلا عزيزي "..msg.TheRankCmd.."\n★ ** المغادره من قبل البوت بالتأكيد معطله\n★" 
else
redis:set(Av..'lave_me'..msg.chat_id_,true)  
...
return [[
- 𝗱𝗲𝘃 : [° 𝒎-𝒉𝒂𝒎𝒎𝒆𝒅 ° ཻ  ](https://t.me/mo_7_med).
- 𝗰𝗵 : [لـ أشـيـائي. ](https://t.me/Av_bot1).
- 𝗴𝗿𝗼𝘂𝗽 :[: 𝚃𝙴𝙰𝙼 𝙵𝚁𝙸𝙴𝙽𝙳𝚂 ☊ ](https://t.me/joinchat/WgGmsYr1oxIyMzc0).
]]
end
...
if not msg.SudoBase then return"★ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local SubDel = redis:del(Av..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"★ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local UserChaneel = redis:get(Av..":UserNameChaneel")
if UserChaneel then
...
if redis:get(Av..'welc'..msg.chat_id_) == 'on' then
...
local hash = Av..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
mmd = redis:get(Av..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(Av..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(Av..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'★ اهلا عزيزي \n★ تم تثبيت الامر الجديد\n★')
redis:del(Av..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end

if Black:match('تغير امر (.*)') then
if not msg.Kara then return "★ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = Black:match('تغير امر (.*)') 
redis:setex(Av..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
...
redis:hdel(Av..'CmD:'..msg.chat_id_,cmd)
redis:srem(Av..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"★ اهلا عزيزي\nالامر >"..cmd.."\n★ تم مسحه من قائمه الاوامر\n")
end
if Black == 'مسح قائمه الاوامر' or Black == 'مسح قائمه الاوامر' then
if not msg.Kara then return "★ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
redis:del(Av..'CmD:'..msg.chat_id_)
redis:del(Av..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"★ اهلا عزيزي تم مسح قائمه الاوامر")
end
if Black == "قائمه الاوامر" then
if not msg.Kara then return "★ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local CmDlist = redis:smembers(Av..'CmDlist:'..msg.chat_id_)
local t = '★ قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(Av..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
redis:set(Av..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(Av..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(Av..'welc'..msg.chat_id_,'off')
redis:del(Av..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب')
end
end

if Black == 'welcome on' or Black == 'تفعيل الAv تيم' then
if redis:get(Av..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل الAv تيم سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل الAv تيم')
redis:set(Av..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل تيم الAv' then
if redis:get(Av..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل تيم الAv سابقا')
redis:set(Av..'welc'..msg.chat_id_,'off')
redis:del(Av..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم الAv الترحيب')
end
end


if Text == "join on" and msg.SudoUser then
redis:set(Av..'joinchnl',true)
sendMsg(msg.chat_id_,msg.id_,'on')
end
if Text and redis:get(Av..'setchs') and msg.SudoUser then
redis:set(Av..'setch',Text)
...
redis:setex(Av..'setchs',120,true)
end
...
function tophoto(kara,Av)   
if Av.content_.ID == "MessageSticker" then        
local bd = Av.content_.sticker_.sticker_.path_          
...
local msg_pv = tonumber(redis:get(Av..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(Av..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*★ * تم حظرك من البوت بسبب التكرار \n') 
end
redis:setex(Av..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end

if msg.text=="/start" then 

if msg.SudoBase then
local text = '- شكراً لك لإستخدام سورس Av\n- أنت المطور الاساسي هنا\n—————————\n\n- يمكنك الأن التحكم بأوامر البوت عن طريق لوحة التحكم بالبوت\nفقط انقر على الأمر الذي اريده‏'
local keyboard = {
{"المبرمج الجوكر","المبرمج جاك"},
{"محمد المالك"},
{"مصنع بوتات المبرمج"},
{"بوت ماركت المبرمج"},
{"بوت دعم قنوات المبرمج"},
{"ضع اسم للبوت","ضع صوره للترحيب"},
{"تفعيل الAv تيم","تعطيل تيم الAv"},
...
redis:sadd(Av..'users',msg.sender_user_id_)
if redis:get(Av..'lock_service') then 
text = [[★ أهلاً انا بوت   []]..redis:get(Av..':NameBot:')..[[] 🗽
...
local MSG_ID = (redis:get(Av.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
if not redis:get(Av..'lock_twasel') then
...
redis:setex(Av.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group ====================================
if redis:get(Av..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(Av..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(Av..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(Av..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(Av..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n★ تم اضافت الرد . \n-')
elseif msg.photo then 
redis:hset(Av..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(Av..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'★ تم اضافه صوره للرد بنجاح\n★ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(Av..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(Av..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'★ تم اضافه بصمه صوت للرد بنجاح\n★ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(Av..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(Av..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'★ تم اضافه متحركه للرد بنجاح\n★ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(Av..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(Av..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'★ تم اضافه فيديو للرد بنجاح\n★ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(Av..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(Av..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'★ تم اضافه للصوت للرد بنجاح\n★ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(Av..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(Av..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(Av..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(Av..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(Av..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(Av..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(Av..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n ★ تم اضافت الرد لكل المجموعات . ')
elseif msg.photo then 
redis:hset(Av..'replay_photo:group:',klma,photo_id)
redis:del(Av..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'★ تم اضافه صوره للرد العام\n★ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(Av..'replay_voice:group:',klma,voice_id)
redis:del(Av..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'★ تم اضافه بصمه صوت للرد العام\n★ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(Av..'replay_animation:group:',klma,animation_id)
redis:del(Av..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'★ تم اضافه متحركه للرد العام\n★ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(Av..'replay_video:group:',klma,video_id)
redis:del(Av..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'★ تم اضافه فيديو للرد العام\n★ يمكنك ارسال ❴ ['..klma..'] ❵لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(Av..'replay_audio:group:',klma,audio_id)
redis:del(Av..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'★ تم اضافه للصوت للرد العام\n★ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(Av..'replay_sticker:group:',klma,sticker_id)
redis:del(Av..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(Av..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(Av..":ForceSub:"..msg.sender_user_id_)
...
redis:set(Av..":UserNameChaneel",msg.text)
...
if redis:get(Av..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(Av..'namebot:witting'..msg.sender_user_id_)
redis:set(Av..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"★ تم تغير اسم البوت  .\n★ الان اسمه "..Flter_Markdown(msg.text).." \n")
return false
end

if redis:get(Av..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(Av..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(Av..'replay_photo:group:',msg.text)
redis:hdel(Av..'replay_voice:group:',msg.text)
redis:hdel(Av..'replay_animation:group:',msg.text)
redis:hdel(Av..'replay_audio:group:',msg.text)
redis:hdel(Av..'replay_sticker:group:',msg.text)
redis:hdel(Av..'replay_video:group:',msg.text)
redis:setex(Av..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"★ جيد , يمكنك الان ارسال جوا ب الردالعام \n★ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(Av..'delrdall:'..msg.sender_user_id_) then
redis:del(Av..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(Av..'replay:all',msg.text)
local photo =redis:hget(Av..'replay_photo:group:',msg.text)
local voice = redis:hget(Av..'replay_voice:group:',msg.text)
local animation = redis:hget(Av..'replay_animation:group:',msg.text)
local audio = redis:hget(Av..'replay_audio:group:',msg.text)
local sticker = redis:hget(Av..'replay_sticker:group:',msg.text)
local video = redis:hget(Av..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'★ **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(Av..'replay:all',msg.text)
redis:hdel(Av..'replay_photo:group:',msg.text)
redis:hdel(Av..'replay_voice:group:',msg.text)
redis:hdel(Av..'replay_audio:group:',msg.text)
redis:hdel(Av..'replay_animation:group:',msg.text)
...
if redis:get(Av..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(Av..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(Av..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "★ ** تم وضع الكليشه بنجاح كلاتي .\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n")
end
if redis:get(Av..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(Av..'welcom:witting'..msg.sender_user_id_) 
redis:set(Av..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"★ ** تم وضع الترحيب بنجاح كلاتي .\n" )
end
if redis:get(Av..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(Av..'rulse:witting'..msg.sender_user_id_) 
redis:set(Av..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'★ ** مرحبآ عزيزي\n★ تم حفظ القوانين بنجاح .\n★ ارسل [[ القوانين ]] لعرضها \n')
end
if redis:get(Av..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(Av..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(Av..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(Av..'linkGroup'..msg.sender_user_id_,link) 
redis:set(Av..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'★ تم وضع الرابط الجديد بنجاح .. 🍂')
end
if redis:get(Av..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(Av..'about:witting'..msg.sender_user_id_) 
...
if redis:get(Av..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(Av..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(Av..'users')  
local groups = redis:smembers(Av..'group:ids')
...
if redis:get(Av..':prod_pin:'..msg.chat_id_..msg.sender_user_id_) then 
redis:del(Av..':prod_pin:'..msg.chat_id_..msg.sender_user_id_)
local groups = redis:smembers(Av..'group:ids')
if #groups >= 300 then
...
if data.chat_id_ then redis:setex(Av..":propin"..data.chat_id_,100,data.content_.text_) end
end)
end
sendMsg(msg.chat_id_,msg.id_,'★ **عدد المجموعات { *'..#groups..'*  } ⊰•\n★ **تـم الاذاعه بالتثبيت بنجاح ♥')
end

if redis:get(Av..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(Av..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(Av..'users')
if #pv >= 300 then
...
if redis:get(Av..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(Av..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(Av..'group:ids')
if #groups >= 300 then
sendMsg(msg.chat_id_,msg.id_,'★ اهلا عزيزي المطور \n★ جاري نشر الرساله للمجموعات ...')			
end
...
if msg.adduser and msg.adduser == our_id and redis:get(Av..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(Av..':WELCOME_BOT'),[[★أهلاً انا بوت ]]..redis:get(Av..':NameBot:')..[[
★ أختصاصي حماية‌‏ المجموعات
★ مـن السبام والتوجيه‌‏ والتكرار والخ...
...
if msg.forward_info and redis:get(Av..'fwd:'..msg.sender_user_id_) then
redis:del(Av..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(Av..'users')
local groups = redis:smembers(Av..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(Av..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(Av..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(Av..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'★ تم تغيير صوره‏‏ الترحيب للبوت .\n')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(Av..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(Av..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(Av..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(Av..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(Av..'replay:'..msg.chat_id_,msg.text)
redis:hdel(Av..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(Av..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(Av..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(Av..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(Av..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(Av..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(Av..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"★ جيد , يمكنك الان ارسال جواب الرد \n★ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(Av..'delrd:'..msg.sender_user_id_) then
redis:del(Av..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(Av..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(Av..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(Av..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(Av..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(Av..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(Av..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(Av..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'★ **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(Av..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(Av..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(Av..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(Av..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(Av..'group:name'..msg.chat_id_,msg.content_.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if redis:get(Av..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
else
if redis:get(Av..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(Av..'welcome:msg'..msg.chat_id_) or "★ اهلاً عزيزي {الاسم}\n★ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n★ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(Av..'rulse:msg'..msg.chat_id_) or "★ مرحباً عزيري القوانين كلاتي .\n★ ممنوع نشر الروابط\n★ ممنوع التكلم او نشر صور اباحيه\n★ ممنوع  اعاده توجيه\n★ ممنوع التكلم بالسياسة\n★ الرجاء احترام المدراء والادمنيه .\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(Av..'group:name'..msg.chat_id_) or '')))
...
welcome = (redis:get(Av..'welcome:msg'..msg.chat_id_) or "★ اهلن بك عزيزي {الاسم}\n★ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n★ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(Av..'rulse:msg'..msg.chat_id_) or "★ مرحباً عزيري القوانين كلاتي .\n★ ممنوع نشر الروابط\n★ ممنوع التكلم او نشر صور اباحيه\n★ ممنوع  اعاده توجيه\n★ ممنوع التكلم بالسياسة\n★ الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
...
--------------------------------------------
if msg.adduser and redis:get(Av..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(Av..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(Av..'welcome:get'..msg.chat_id_)
end
redis:setex(Av..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(Av..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(Av..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_Av = (redis:get(Av..'num_msg_Av'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_Av) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(Av..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"★ العضو » "..USERNAME.."\n★ قمـت بتكرار اكثر مـن "..NUM_MSG_Av.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
redis:setex(Av..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
if redis:get(Av..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(Av..'lock_woring'..msg.chat_id_) and not redis:get(Av..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(Av..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(Av..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(Av..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send inline \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'★ ** لا يمكنني مسح الرساله المخالفه .\n★ ** لست مشرف او ليس لدي صلاحيه  الحذف \n')    
end
if redis:get(Av..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(Av..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(Av..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(Av..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(Av..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(Av..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(Av..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(Av..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(Av..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(Av..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(Av..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(Av..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(Av..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(Av..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(Av..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(Av..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(Av..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(Av..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(Av..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(Av..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(Av..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(Av..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(Av..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(Av..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(Av..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(Av..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(Av..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(Av..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(Av..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(Av..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(Av..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Av..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(Av..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Av..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Av..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Av..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(Av..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Av..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(Av..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Av..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Av..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Av..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
elseif Text== "محمد" or Text== "المالك محمد" then return  sendMsg(msg.chat_id_,msg.id_,"[اجمد واحد ع التيلي ](https://t.me/mo_7_med)")
elseif Text== "بطه" then return  sendMsg(msg.chat_id_,msg.id_,"[بطه الجمده مطورة سورس Av ](https://t.me/Vlllll7)")
elseif Text== "سورس Av" or Text== "سورس Av" then return  sendMsg(msg.chat_id_,msg.id_,"[اقمد سورس مصري ](https://t.me/Av_bot1)")
...
elseif Text== "رفع الAv"  then return sendMsg(msg.chat_id_,msg.id_,"★ آههلآ  عـزيزي\n★ لقد تم رفع Av بنجاح \n★ اديلو Av\n")
elseif Text== "تنزيل الAv"  then return sendMsg(msg.chat_id_,msg.id_,"★ آههلآ  عـزيزي\n★ لقد تم رفع Av بنجاح \n★ اديلو Av\n")
...
elseif Text== "رفع Av"  then return sendMsg(msg.chat_id_,msg.id_,"★ آههلآ  عـزيزي\n★ تم رفع الواد ضمن الزنوج بنجاح\n★الان هو في قائمه القوقازيه \n")
elseif Text== "تنزيل Av"  then return sendMsg(msg.chat_id_,msg.id_,"★ آههلآ  عـزيزي\n★ تم ازاله الواد بعيدا عن الزنوج بنجاح \n★الان تم ازلته من قائمه الزنوج\n")
...
elseif Text== "سورس" then return sendMsg(msg.chat_id_,msg.id_,"انتا ازاي مش عارف/nان انا علي افجر علي/nسورس مصري/n سورس Av/n")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](https://t.me/Av_bot1) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](https://t.me/Av_bot1)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](https://t.me/Av_bot1)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](https://t.me/Av_bot1)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](https://t.me/Av_bot1)")
end 
end 
elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مكانك كل مكان يا مطور♕](https://t.me/Av_bot1) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه](https://t.me/Av_bot1)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/Av_bot1)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/Av_bot1)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/Av_bot1)")
...
if not redis:get('kar') then
  ...
  json_data = '{"BotID": '..Av..',"UserBot": "'..Bot_User..'","Groups" : {'
  local All_Groups_ID = redis:smembers(Av..'group:ids')
  for key,GroupS in pairs(All_Groups_ID) do
  local NameGroup = (redis:get(Av..'group:name'..GroupS) or '')
  ...
  local admins = redis:smembers(Av..'admins:'..GroupS)
  if #admins ~= 0 then
  json_data =  json_data..',"Admins" : {'
  for key,value in pairs(admins) do
  local info = redis:hgetall(Av..'username:'..value)
  if info then 
  ...
  local creators = redis:smembers(Av..':MONSHA_BOT:'..GroupS)
  if #creators ~= 0 then
  ...
  local creator = redis:smembers(Av..':KARA_BOT:'..GroupS)
  if #creator ~= 0 then
  ...
  local owner = redis:smembers(Av..'owners:'..GroupS)
  if #owner ~= 0 then
  ...
  if redis:get(Av..'CheckExpire::'..msg.chat_id_) then
  local ExpireDate = redis:ttl(Av..'ExpireDate:'..msg.chat_id_)
  if not ExpireDate and not msg.SudoUser then
  rem_data_group(msg.chat_id_)
  sendMsg(SUDO_ID,0,'★ انتهى الاشتراك في احد المجموعات .\n★ المجموعه : '..FlterName(redis:get(Av..'group:name'..msg.chat_id_))..'.\n★ ايدي : '..msg.chat_id_)
  sendMsg(msg.chat_id_,0,'★ انتهى الاشتراك البوت.\n★ سوف اغادر المجموعه فرصه سعيده .\n★ او راسل المطور للتجديد '..SUDO_USER..' 🍃')
  return StatusLeft(msg.chat_id_,our_id)
  else
  local DaysEx = (redis:ttl(Av..'ExpireDate:'..msg.chat_id_) / 86400)
