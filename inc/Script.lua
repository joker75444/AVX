...
return '♕ Av اصدار سورس  : *v'..version..'* \n'
end
...
send_key(msg.sender_user_id_,'   [قناة سورس : اڤ](https://t.me/Av_bot1)' ,nil,inline,msg.id_)
return false
end
...
if MsgText[1]== "المطور مالك" and msg.type == "pv" then
...
redis:del(Av..'replay:'..msg.chat_id_,Av..'replay_photo:group:'..msg.chat_id_,black..'replay_voice:group:'..msg.chat_id_,
...
- 𝗰𝗵 : [ ѕᴏụʀᴄᴇ ᴀᴠ . ](https://t.me/Av_bot1).
...
if Black and (Av:match('^delcmd (.*)') or Black:match('^مسح امر (.*)')) then
if not msg.Kara then return "♕ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = Av:match('^delcmd (.*)') or Black:match('^مسح امر (.*)')
redis:hdel(Av..'CmD:'..msg.chat_id_,cmd)
redis:srem(Av..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"♕ اهلا عزيزي\nالامر >"..cmd.."\n♕ تم مسحه من قائمه الاوامر\n")
end
if Av == 'مسح قائمه الاوامر' or Av == 'مسح قائمه الاوامر' then
if not msg.Kara then return "♕ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
...
if Av == 'welcome on' or Av == 'تفعيل الترحيب' then
if redis:get(Av..'welc'..msg.chat_id_) == 'on' then
...
if Av == 'welcome on' or Av == 'تفعيل اڤ تيم' then
if redis:get(Av..'welc'..msg.chat_id_) == 'on' then
...
if Text == 'welcome off' or Text == 'تعطيل تيم اڤ' then
if redis:get(Av..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل تيم اڤ سابقا')
redis:set(black..'welc'..msg.chat_id_,'off')
redis:del(black..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم اڤ الترحيب')
end
end
...
elseif msg.sticker then
redis:hsetAv..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(Av..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
elseif Text== "رفع اڤ"  then return sendMsg(msg.chat_id_,msg.id_,"❍ آههلآ  عـزيزي\n❍ لقد تم رفع اڤ بنجاح \n❍ اديلو اڤ\n")
elseif Text== "تنزيل اڤ"  then return sendMsg(msg.chat_id_,msg.id_,"❍ آههلآ  عـزيزي\n❍ لقد تم رفع اڤ بنجاح \n❍ اديلو اڤ\n")
...
elseif Text:match(Bot_Name.."كيفك") then 
  ...
  elseif Text==" رابط الحذف" or Text==
" رابط حذف" or Text=="رابط حذف" or Text=="رابط الحذف" then
  return sendMsg(msg.chat_id_,msg.id_,[[
...
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو خول هنا 𖦹](https://t.me/Av_bot1)")
end 
end 
