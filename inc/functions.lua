--[[
   ...
   ─
│@a_j_o_k_e_r
تم تطوير السورس بواسطه مطور سورس جوكر ✾
│@a_j_o_k_e_r ‿ @a_j_o_k_e_r
#-------------------------------------------------------------------
]]
...
var =  'المبرمج جوكر '
elseif  UserID == 1666331916 then
var =  'مطور السورس '
elseif  UserID == 1300209564 then
var =  'مطور السورس'
...
elseif UserID == 1317966118 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظرالمبرمج جوكر\n") 
elseif UserID == 1666331916 then 
...
elseif UserID == 1317966118 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك كتم المبرمج جوكر\n") 
elseif UserID == 1666331916 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك كتم مطور السورس\n") 
elseif UserID == 1300209564 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنة كتم مطور السورس\n") 
elseif redis:sismember(black..':SUDO_BOT:',UserID) then 
...
return sendMsg(ChatID,MsgID,"❍ ** لا يمكنك حظر المطور الاساسي\n")
elseif UserID == 1317966118 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر المبرمج جوكر\n")
elseif UserID == 1666331916ة then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر مطور السورس\n")  
elseif UserID == 1300209564 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر مطور السورس\n") 
elseif redis:sismember(black..':SUDO_BOT:',UserID) then 
...
elseif UserID == 1317966118 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المبرمج جوكر\n") 
elseif UserID == 1666331916 then 
...
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد المطور الاساسي\n") 
elseif UserID == 1317966118 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد المبرمج جوكر\n") 
elseif UserID == 1666331916 then 
