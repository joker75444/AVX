...
print('\27[0;33m>>'..[[
echo -e "\e[38;5;77m       •{ تنصيب سورس اڤ بنسبه 100% ]  }•\e[0m"
echo -e "\e[38;5;77m       •{ •{ Join the Source Channel : @Av_bot1 }• }•\e[0m"
...
echo -e "\e[38;5;77m       •{ SOURCE AV source has been installed }•\e[0m"
echo -e "\e[38;5;77m       •{ developer JOKER : @a_j_o_k_e_r  }•\e[0m"

echo -e "\e[38;5;77m      AV ✾ @a_j_o_k_e_re[0m"
echo -e "\e[38;5;77m       ✾تم تطوير وبرمجة السورس من قبل جوكر ✾ .e[0m"
echo -e "\e[38;5;77m       ✾ @a_j_o_k_e_re[0m"
-------------------------------------------------------------------
]]..'\027[0;32m')
create_config() 
else
...
echo -e "\e[38;5;77m     AV ✾ @V_P_Ee[0m"
echo -e "\e[38;5;77m     ✾تم تطوير وبرمجة السورس من قبل جوكر ✾ .e[0m"
echo -e "\e[38;5;77m     ✾ @a_j_o_k_e_re[0m"
-ـ-ـ-ـ-ـ-ــ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ--ـ-ـ-ـ-ـ
...
elseif msg.sender_user_id_ == 1666331916 then 
msg.TheRank =  ' مطور السورس '
msg.Rank = 1

elseif msg.sender_user_id_ == 1300209564 then 
msg.TheRank =  ' مطور السورس '
msg.Rank = 1
...
• قنـاة سورس اڤ ⇐ @Av_bot1. مـعرف المطور  :]]..SUDO_USER:gsub([[\_]],'_')..[[ .
]])
return false
end
if not msg then
